            ...
            <div className="flex flex-col gap-6">
              <div className="space-y-3">
                ...
                <p className="text-pretty text-sm leading-relaxed text-zinc-300 md:text-base">
                  Capture reusable code, store VS Code and Neovim settings, and
                  share with your team. Powerful tags and instant search wrapped
                  in a polished, mobile‑first glass UI.
                </p>
              </div>
            ...
            <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-zinc-300">
                  Create your first snippet or import your editor configs in
                  seconds.
                </p>
              </div>
